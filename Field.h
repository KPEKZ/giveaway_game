...
public:
	...
	bool ValidateChoose(Cells::position Pos, Cells cell); /*проверка на возможность хода*/
	bool ValidateSell(Cells::position endPos , Cells cell, Field* field, Cells::position PrevPos); /*проверка хода*/
